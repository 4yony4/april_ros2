...
: ${AMENT_CURRENT_PREFIX:="/home/yony/Dev/ros2_ws/install/sim"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/sim/environment/pythonpath.sh"
