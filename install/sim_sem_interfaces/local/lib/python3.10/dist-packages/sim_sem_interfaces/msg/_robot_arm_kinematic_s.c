...
bool sim_sem_interfaces__msg__robot_arm_kinematic__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sim_sem_interfaces.msg._robot_arm_kinematic.RobotArmKinematic", full_classname_dest, 61) == 0);
  }
  sim_sem_interfaces__msg__RobotArmKinematic * ros_message = _ros_message;
  {  // position
...
PyObject * sim_sem_interfaces__msg__robot_arm_kinematic__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sim_sem_interfaces.msg._robot_arm_kinematic");
