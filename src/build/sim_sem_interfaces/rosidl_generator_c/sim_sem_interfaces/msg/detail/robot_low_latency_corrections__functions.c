...
sim_sem_interfaces__msg__RobotLowLatencyCorrections__create()
{
  ...
  sim_sem_interfaces__msg__RobotLowLatencyCorrections * msg = (sim_sem_interfaces__msg__RobotLowLatencyCorrections *)allocator.allocate(sizeof(sim_sem_interfaces__msg__RobotLowLatencyCorrections), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sim_sem_interfaces__msg__RobotLowLatencyCorrections));
  bool success = sim_sem_interfaces__msg__RobotLowLatencyCorrections__init(msg);
  if (!success) {
...
sim_sem_interfaces__msg__RobotLowLatencyCorrections__destroy(sim_sem_interfaces__msg__RobotLowLatencyCorrections * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    sim_sem_interfaces__msg__RobotLowLatencyCorrections__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
sim_sem_interfaces__msg__RobotLowLatencyCorrections__Sequence__init(sim_sem_interfaces__msg__RobotLowLatencyCorrections__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sim_sem_interfaces__msg__RobotLowLatencyCorrections * data = NULL;

  if (size) {
    data = (sim_sem_interfaces__msg__RobotLowLatencyCorrections *)allocator.zero_allocate(size, sizeof(sim_sem_interfaces__msg__RobotLowLatencyCorrections), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sim_sem_interfaces__msg__RobotLowLatencyCorrections__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        sim_sem_interfaces__msg__RobotLowLatencyCorrections__fini(&data[i - 1]);
      }
...
sim_sem_interfaces__msg__RobotLowLatencyCorrections__Sequence__fini(sim_sem_interfaces__msg__RobotLowLatencyCorrections__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      sim_sem_interfaces__msg__RobotLowLatencyCorrections__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sim_sem_interfaces__msg__RobotLowLatencyCorrections__Sequence * array = (sim_sem_interfaces__msg__RobotLowLatencyCorrections__Sequence *)allocator.allocate(sizeof(sim_sem_interfaces__msg__RobotLowLatencyCorrections__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = sim_sem_interfaces__msg__RobotLowLatencyCorrections__Sequence__init(array, size);
  if (!success) {
...
sim_sem_interfaces__msg__RobotLowLatencyCorrections__Sequence__destroy(sim_sem_interfaces__msg__RobotLowLatencyCorrections__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    sim_sem_interfaces__msg__RobotLowLatencyCorrections__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
sim_sem_interfaces__msg__RobotLowLatencyCorrections__Sequence__are_equal(const sim_sem_interfaces__msg__RobotLowLatencyCorrections__Sequence * lhs, const sim_sem_interfaces__msg__RobotLowLatencyCorrections__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sim_sem_interfaces__msg__RobotLowLatencyCorrections__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  sim_sem_interfaces__msg__RobotLowLatencyCorrections__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sim_sem_interfaces__msg__RobotLowLatencyCorrections);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sim_sem_interfaces__msg__RobotLowLatencyCorrections * data =
      (sim_sem_interfaces__msg__RobotLowLatencyCorrections *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sim_sem_interfaces__msg__RobotLowLatencyCorrections__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          sim_sem_interfaces__msg__RobotLowLatencyCorrections__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!sim_sem_interfaces__msg__RobotLowLatencyCorrections__copy(
