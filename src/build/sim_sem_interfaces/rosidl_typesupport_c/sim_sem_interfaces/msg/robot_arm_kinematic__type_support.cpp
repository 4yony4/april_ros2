...
static const _RobotArmKinematic_type_support_symbol_names_t _RobotArmKinematic_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sim_sem_interfaces, msg, RobotArmKinematic)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sim_sem_interfaces, msg, RobotArmKinematic)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sim_sem_interfaces, msg, RobotArmKinematic)() {
  return &::sim_sem_interfaces::msg::rosidl_typesupport_c::RobotArmKinematic_message_type_support_handle;
}
