...
#include "sim_sem_interfaces/msg/detail/robot_arm_kinematic__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const sim_sem_interfaces::msg::RobotArmKinematic *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sim_sem_interfaces::msg::RobotArmKinematic *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RobotArmKinematic__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const sim_sem_interfaces::msg::RobotArmKinematic *>(
...
static size_t _RobotArmKinematic__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RobotArmKinematic(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RobotArmKinematic__callbacks = {
...
static rosidl_message_type_support_t _RobotArmKinematic__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RobotArmKinematic__callbacks,
...
{
  return &sim_sem_interfaces::msg::typesupport_fastrtps_cpp::_RobotArmKinematic__handle;
}
