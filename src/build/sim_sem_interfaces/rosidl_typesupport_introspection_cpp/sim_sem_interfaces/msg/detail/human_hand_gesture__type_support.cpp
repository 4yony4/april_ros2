...
{
  new (message_memory) sim_sem_interfaces::msg::HumanHandGesture(_init);
}

void HumanHandGesture_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sim_sem_interfaces::msg::HumanHandGesture *>(message_memory);
  typed_message->~HumanHandGesture();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember HumanHandGesture_message_member_array[1] = {
  {
    ...
    offsetof(sim_sem_interfaces::msg::HumanHandGesture, recognized_gesture),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers HumanHandGesture_message_members = {
  ...
  1,  // number of fields
  sizeof(sim_sem_interfaces::msg::HumanHandGesture),
...
{
  return &::sim_sem_interfaces::msg::rosidl_typesupport_introspection_cpp::HumanHandGesture_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sim_sem_interfaces, msg, HumanHandGesture)() {
  return &::sim_sem_interfaces::msg::rosidl_typesupport_introspection_cpp::HumanHandGesture_message_type_support_handle;
}
