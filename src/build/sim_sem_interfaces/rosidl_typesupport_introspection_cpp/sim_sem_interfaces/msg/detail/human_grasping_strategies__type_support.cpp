...
{
  new (message_memory) sim_sem_interfaces::msg::HumanGraspingStrategies(_init);
}

void HumanGraspingStrategies_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sim_sem_interfaces::msg::HumanGraspingStrategies *>(message_memory);
...
void fetch_function__HumanGraspingStrategies__type(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__HumanGraspingStrategies__type(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__HumanGraspingStrategies__type(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__HumanGraspingStrategies__type(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HumanGraspingStrategies_message_member_array[2] = {
  {
    "type",  // name
    ...
    offsetof(sim_sem_interfaces::msg::HumanGraspingStrategies, type),  // bytes offset in struct
    ...
    fetch_function__HumanGraspingStrategies__type,  // fetch(index, &value) function pointer
    assign_function__HumanGraspingStrategies__type,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sim_sem_interfaces::msg::HumanGraspingStrategies, location),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers HumanGraspingStrategies_message_members = {
  ...
  2,  // number of fields
  sizeof(sim_sem_interfaces::msg::HumanGraspingStrategies),
...
{
  return &::sim_sem_interfaces::msg::rosidl_typesupport_introspection_cpp::HumanGraspingStrategies_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sim_sem_interfaces, msg, HumanGraspingStrategies)() {
  return &::sim_sem_interfaces::msg::rosidl_typesupport_introspection_cpp::HumanGraspingStrategies_message_type_support_handle;
}
