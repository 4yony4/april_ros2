...
class cam_main : public rclcpp::Node
{
  public:
    cam_main()
    : Node("cam_main")
    {
      ...
      //printf("hello world rgb_camera package\n");
      init_cam();
      rclcpp::shutdown();
  ...
  private:
    ...
    String fd_modelPath = "/home/jbarmagen/Dev/ROS2/april_ros2/src/rgb_camera/src/onnx/face_detection_yunet_2022mar.onnx";
    String fr_modelPath = "/home/jbarmagen/Dev/ROS2/april_ros2/src/rgb_camera/src/onnx/face_recognition_sface_2021dec.onnx";
...
int main(int argc, char ** argv)
{
  ...
  rclcpp::spin(std::make_shared<cam_main>());
  rclcpp::shutdown();
