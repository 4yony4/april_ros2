...
static const _HumanParameterIntention_type_support_symbol_names_t _HumanParameterIntention_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sim_sem_interfaces, msg, HumanParameterIntention)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sim_sem_interfaces, msg, HumanParameterIntention)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sim_sem_interfaces, msg, HumanParameterIntention)() {
  return &::sim_sem_interfaces::msg::rosidl_typesupport_c::HumanParameterIntention_message_type_support_handle;
}
