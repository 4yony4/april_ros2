...
static const _RobotHighLatencyCorrections_type_support_symbol_names_t _RobotHighLatencyCorrections_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sim_sem_interfaces, msg, RobotHighLatencyCorrections)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sim_sem_interfaces, msg, RobotHighLatencyCorrections)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sim_sem_interfaces, msg, RobotHighLatencyCorrections)() {
  return &::sim_sem_interfaces::msg::rosidl_typesupport_c::RobotHighLatencyCorrections_message_type_support_handle;
}
