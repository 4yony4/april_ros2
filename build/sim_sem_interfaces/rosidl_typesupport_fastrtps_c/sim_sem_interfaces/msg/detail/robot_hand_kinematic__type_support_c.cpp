...
#include "sim_sem_interfaces/msg/detail/robot_hand_kinematic__rosidl_typesupport_fastrtps_c.h"
...
using _RobotHandKinematic__ros_msg_type = sim_sem_interfaces__msg__RobotHandKinematic;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RobotHandKinematic__ros_msg_type * ros_message = static_cast<const _RobotHandKinematic__ros_msg_type *>(untyped_ros_message);
  // Field name: position
  {
  ...
  void * untyped_ros_message)
{
  ...
  _RobotHandKinematic__ros_msg_type * ros_message = static_cast<_RobotHandKinematic__ros_msg_type *>(untyped_ros_message);
  // Field name: position
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _RobotHandKinematic__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sim_sem_interfaces__msg__RobotHandKinematic(
...
static size_t _RobotHandKinematic__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sim_sem_interfaces__msg__RobotHandKinematic(
...
static message_type_support_callbacks_t __callbacks_RobotHandKinematic = {
...
static rosidl_message_type_support_t _RobotHandKinematic__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RobotHandKinematic,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sim_sem_interfaces, msg, RobotHandKinematic)() {
  return &_RobotHandKinematic__type_support;
}
